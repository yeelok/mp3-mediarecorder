(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports):typeof define==='function'&&define.amd?define(['exports'],f):(g=g||self,f(g.mp3MediaRecorder={}));}(this,(function(exports){'use strict';/**
...
function pd(event) {
  ...
  if (retv == null) {
    throw new TypeError("'this' is expected an Event object, but got another value.");
  }
...
defineEventAttribute(Mp3MediaRecorder.prototype, 'error');exports.Mp3MediaRecorder=Mp3MediaRecorder;Object.defineProperty(exports,'__esModule',{value:true});})));//# sourceMappingURL=index.umd.js.map
